...
- ⏳ **Expiry Tracker** — track perishables and expiration dates
- 🔗 **URL Shortener** — short codes with owner-based deletion
- 📥 **Media Downloader** — yt-dlp powered downloads with progress polling
- 📄 **PDF Compressor** — upload, compress, preview, and download PDFs
- 📲 **QR Generator** — text/URL + WiFi QR codes with history
- 📤 **Shared Cloud / Uploads** — family file sharing with preview and download
